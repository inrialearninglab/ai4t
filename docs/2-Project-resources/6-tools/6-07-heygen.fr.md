...
Heygen est une IA spécialisée dans la génération de vidéos avec des avatars animés. Elle permet de créer des vidéos réalistes où des avatars parlent avec des voix naturelles à partir d'un simple texte.

## Fonctionnalités principales :

·	Avatars réalistes : Permet d’animer des personnages humains qui prononcent un texte généré par l’IA.
