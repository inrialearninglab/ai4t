...
- Interactive whiteboards: Create and collaborate on virtual whiteboards with drawing tools, post-it notes, diagrams, etc. suitable for collaborative activities.
...
- Premium subscription: Some advanced features require a paid subscription, although the basic version is free and offers many possibilities.
- Complexity for new users: Although the tool is intuitive, users new to project management or collaborative work may need some time to adapt to the features.

Link to the tool: [Miro](https://miro.com/miroverse/welcome-to-miro/)

[^1]: Source: Miro website
