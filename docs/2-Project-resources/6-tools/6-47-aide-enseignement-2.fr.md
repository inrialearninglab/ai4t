...
Description :  
Khan Academy propose une plateforme éducative en ligne avec des vidéos, des exercices et des quiz interactifs. Grâce à l’IA, la plateforme adapte le parcours d'apprentissage de chaque élève, offrant des recommandations personnalisées et ajustant la difficulté des exercices en fonction des réponses de l’élève.

✅ Exemple d’utilisation :  
Un élève ayant des difficultés en mathématiques peut recevoir des recommandations spécifiques pour des vidéos et exercices supplémentaires sur des concepts qu'il maîtrise moins bien, tout en suivant son propre rythme. L'IA ajuste automatiquement le niveau de difficulté et lui propose des révisions basées sur ses progrès.

### Socrative (Plateforme d’évaluation et d’apprentissage)
...
Description :  
Quizlet utilise l’IA pour générer des jeux de cartes de révision et des tests interactifs adaptés au niveau de l'élève. L'IA analyse les performances passées de l’élève pour ajuster les questions suivantes et s'assurer que les points faibles sont renforcés.

✅ Exemple d’utilisation :  
Un élève utilise Quizlet pour réviser le vocabulaire d’une langue étrangère. En fonction de ses erreurs précédentes, l'IA lui propose des cartes de révision plus ciblées sur les mots qu'il n'a pas encore maîtrisés, optimisant ainsi le processus d’apprentissage.

### Cerego (Révision adaptative basée sur la mémoire)

Description :  
Cerego est un outil d’apprentissage qui s’appuie sur la mémoire à long terme et l’IA pour créer des plans de révision personnalisés. L’IA utilise des algorithmes de répétition espacée pour optimiser les séances d’étude de l’élève.

✅ Exemple d’utilisation :  
Un élève étudiant l’histoire peut utiliser Cerego pour revoir les dates importantes et les événements. L’IA l’aide à organiser ses révisions en fonction de ses performances passées et du temps qu’il reste avant un examen, en lui proposant des rappels personnalisés pour renforcer sa mémoire.

### AI Dungeon (Création de récits interactifs)

Description :  
AI Dungeon utilise l'IA pour générer des récits interactifs et des aventures textuelles. Il permet aux élèves de créer et d'explorer des histoires de manière totalement personnalisée.

✅ Exemple d’utilisation :  
Un élève peut utiliser AI Dungeon pour créer un récit basé sur un thème d'histoire, comme la révolution française. L’IA l’aide à développer une histoire en lui proposant des choix et des directions, tout en enrichissant l’expérience d’écriture et d’apprentissage à travers la narration.
```
