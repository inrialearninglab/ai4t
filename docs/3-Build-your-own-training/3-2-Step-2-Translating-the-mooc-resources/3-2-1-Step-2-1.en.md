...
The methodology requires the DeepL API [https://www.deepl.com/pro-api?cta=header-pro-api/](https://www.deepl.com/pro-api?cta=header-pro-api/).
...
<figure class="image-frame">
    <img src="Images/3.2-dowloading-a-repository-in-github-as-ZIP.png" alt="Creating an account on github">
    <figcaption>Creating an account on github.</figcaption>
</figure>
...
<figure class="image-frame">
    <img src="3.2-moving-a-folder-from-file-explorer-to-terminal.png" alt="Move the file from file explorer to terminal - screen caption">
      <figcaption>Move the file from file explorer to terminal - screen caption.</figcaption>
</figure>
...
-   Suggest substitutions or additions in the target language for resources cited in the target language (articles, books, websites, activities, etc.).

**See dedicated tutorial:** [Step 2.2 - Proofreading texts](https://inrialearninglab.github.io/ai4t///3-Build-your-own-training/3-2-Step-2-Translating-the-mooc-resources/3-2-2-Step-2-2.html)
