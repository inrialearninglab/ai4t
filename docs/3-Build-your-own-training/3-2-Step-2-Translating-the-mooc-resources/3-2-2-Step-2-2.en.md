...
<figure class="image-frame">
    <img src="Images/3.2-3.2-Seach-tool-on-Github-screen-caption.png" alt="Example of a search result for Teacher-in-the-loop - screen caption of Github ">
</figure>
...
-   Once you have completed your corrections and checked them in the \"Preview\" mode, briefly describe the nature of your changes in the **\"[Commit message]{.mark}\"** box.
...
-   Finally click on the green **\"Commit changes\"** button to publish your changes.[\]{.mark}
<figure>
...
<figure>
    <img src="Images/3.2-Do-not-change-the-title-of-the-page.png" alt="Visual - Title a pgae to be kept as such - screencaption of github."/>
</figure>
