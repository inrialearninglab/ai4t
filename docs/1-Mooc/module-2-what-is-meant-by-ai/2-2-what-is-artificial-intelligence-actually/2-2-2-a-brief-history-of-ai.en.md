...
In 2022, generative AI (text, sound, image), the theoretical foundations of which date back to the 2010s, are being made available to the general public via dedicated interfaces and are enjoying huge popular success. Since then, they have been used in a wide range of fields (industry, research, education, the arts), but they also raise a number of questions about the consequences of misuse (particularly in the field of teaching and learning) and the role of AI's little hands.
