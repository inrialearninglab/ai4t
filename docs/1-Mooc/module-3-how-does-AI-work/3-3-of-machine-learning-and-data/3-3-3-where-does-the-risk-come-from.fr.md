...
Comme pour tout système numérique, les données utilisées dans les plateformes basées sur l'IA proviennent de différentes sources et ont des formats multiples. Elles sont porteuses de différents types de biais[^2]. Les biais des données sont principalement d'ordre statistique. Nous allons en énumérer quelques-uns[^3].

- **Le biais d'échantillonnage** est généralement présent dans les valeurs des données. Par exemple, c'est le cas d'un algorithme de recrutement entraîné sur une base de données dans laquelle les hommes sont surreprésentés qui exclura les femmes.
...
[^1]: L'intelligence artificielle : Comment fonctionne-t-elle, pourquoi est-elle importante, et que pouvons-nous faire ? Panel pour l'avenir de la science et de la technologie- EPRS/Scientific Foresight Unit- P. Boucher, 2020

[^2]: [Algorithmes, données et biais : des politiques publiques nécessaires](https://www.institutmontaigne.org/en/analysis/algorithms-data-and-bias-public-policy-needed?_wrapper_format=html), Anne Bouverot, Thierry Delaporte, 2019
