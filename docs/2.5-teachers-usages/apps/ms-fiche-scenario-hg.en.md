---
title: Raising Awareness of Natural Disasters with AI
...
| AI / Digital Tool   | Main Use                                                                    | Educational Applications                                                        | Link                                                                                        |
| ------------------- | --------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| **Claude**          | Generating creative ideas, text reformulation, and writing assistance       | Stimulates creativity in designing educational projects and awareness campaigns | [claude.ai](https://claude.ai/)                                                             |
| **Canva**           | Creating visually engaging materials (posters, infographics, presentations) | Facilitates visual communication and concept understanding                      | [canva.com](https://www.canva.com/)                                                         |
| **Canva AI**        | Generating images, mockups, and visuals from text prompts                   | Allows students to create original and impactful visuals for projects           | [canva.com/features/ai-image-generator](https://www.canva.com/features/ai-image-generator/) |
...
* Analyze the causes and impacts of natural disasters.
* Develop prevention and risk management strategies.
...
* Research and create natural disaster scenarios using Perplexity AI.
...
* Research ideas and design the campaign concept with Claude.
...
* Present campaign projects (posters, visuals, texts).
* Students explain the AI tools used and their role in the project.
* Final discussion: learning outcomes, importance of prevention, and the impact of AI tools.
